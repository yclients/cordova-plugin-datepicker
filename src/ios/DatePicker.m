...
- (BOOL)showForPhone:(NSMutableDictionary *)options {
	...
	self.datePickerComponentsContainer.frame = CGRectOffset(frame, 0, frame.size.height );
...
- (void)hide {
	//if (isIPhone) {
	CGRect frame = CGRectOffset(self.datePickerComponentsContainer.frame, 0, self.datePickerComponentsContainer.frame.size.height);
